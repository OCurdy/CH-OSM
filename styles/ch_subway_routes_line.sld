<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>ch_metrolines_line</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_metrolines_line </sld:Name>
      <sld:Title/>
      <sld:FeatureTypeStyle>
        <sld:Name>ch_metrolines_line</sld:Name>
        <sld:Rule>
          <sld:Name>Ligne de métro</sld:Name>
          <sld:Title>Ligne de métro
              <sld:Localized lang="de">U-Bahn-Linie</sld:Localized>
              <sld:Localized lang="fr">Ligne de métro</sld:Localized>
              <sld:Localized lang="it">Linea della metropolitana</sld:Localized>
              <sld:Localized lang="rm">Lingia da metro</sld:Localized>
              <sld:Localized lang="en">Metro line</sld:Localized>
          </sld:Title>
          <ogc:Filter>
        ...
        <sld:Rule>
          <!--sld:Name>Ligne de métro Label TextSymbolizer</sld:Name-->
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
                                <ogc:PropertyName>route</ogc:PropertyName>
                                <ogc:Literal>subway</ogc:Literal>
