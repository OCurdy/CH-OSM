<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>ch_railways_line</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_railways_line</sld:Name>
      <sld:Title/>
      <sld:FeatureTypeStyle>
        <sld:Name>ch_railways_line</sld:Name>
        <sld:Rule>
          <sld:Name>Pont</sld:Name>
          <sld:Title>Pont (bridge)
              <sld:Localized lang="de">Brücke</sld:Localized>
              <sld:Localized lang="fr">Pont</sld:Localized>
              <sld:Localized lang="it">Ponte</sld:Localized>
              <sld:Localized lang="rm">Punt</sld:Localized>
              <sld:Localized lang="en">Bridge</sld:Localized>
          </sld:Title>
          <ogc:Filter>
            <ogc:And>
        ...
        <sld:Rule>
          <sld:Name>Voie ferrée</sld:Name>
          <sld:Title>Voie ferrée (railway)
              <sld:Localized lang="de">Eisenbahnstrecke</sld:Localized>
              <sld:Localized lang="fr">Voie ferrée</sld:Localized>
              <sld:Localized lang="it">Ferrovia</sld:Localized>
              <sld:Localized lang="rm">Viafier</sld:Localized>
              <sld:Localized lang="en">Railway</sld:Localized>
          </sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>railway</ogc:PropertyName>
        ...
        <sld:Rule>
          ...
          <sld:Title>Tunnel
              <sld:Localized lang="de">Tunnel</sld:Localized>
              <sld:Localized lang="fr">Tunnel</sld:Localized>
              <sld:Localized lang="it">Galleria</sld:Localized>
              <sld:Localized lang="rm">Tunnel</sld:Localized>
              <sld:Localized lang="en">Tunnel</sld:Localized>
          </sld:Title>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsEqualTo>
