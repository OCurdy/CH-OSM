<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>ch_constructions</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_constructions</sld:Name>
            <sld:FeatureTypeStyle>  
      <!-- symbolisation des points -->
        <sld:Rule> <!--règle pour visualisation à échelle worldwide, [MIN:zoom4 et +-->
        <sld:Title>Construction ponctuelle
            <sld:Localized lang="de">Punktbauwerk</sld:Localized>
            <sld:Localized lang="fr">Construction ponctuelle</sld:Localized>
            <sld:Localized lang="it">Costruzione puntuale</sld:Localized>
            <sld:Localized lang="en">Point Construction</sld:Localized>
            <sld:Localized lang="rm">Construcziun punctuala</sld:Localized>
        </sld:Title>
          <ogc:Filter>
           <ogc:Or> 
      ...
      <sld:FeatureTypeStyle>
       <!-- symbolisation des lignes, filtrage par géométrie pour ne pas prendre en compte les points (geom) des chemins qui sont différents des POI-->
          ...
          <sld:Title>Construction linéaire
              <sld:Localized lang="de">Lineare Konstruktion</sld:Localized>
              <sld:Localized lang="fr">Construction linéaire</sld:Localized>
              <sld:Localized lang="it">Costruzione lineare</sld:Localized>
              <sld:Localized lang="en">Linear Construction</sld:Localized>
              <sld:Localized lang="rm">Construcziun linear</sld:Localized>
          </sld:Title>
