<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>ch_tramlines_line</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_tramlines_line</sld:Name>
      <sld:Title/>
      <sld:FeatureTypeStyle>
        <sld:Name>ch_tramlines_line</sld:Name>
        <sld:Rule>
          <sld:Name>Ligne de tram</sld:Name>
          <sld:Title>Ligne de tram
              <sld:Localized lang="de">Straßenbahnlinie</sld:Localized>
              <sld:Localized lang="fr">Ligne de tram</sld:Localized>
              <sld:Localized lang="it">Linea del tram</sld:Localized>
              <sld:Localized lang="rm">Lingia da tram</sld:Localized>
              <sld:Localized lang="en">Tram line</sld:Localized>
          </sld:Title>
          <ogc:Filter>
        ...
        <sld:Rule>
          <!--sld:Name>Ligne de tram Label TextSymbolizer</sld:Name-->
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
                                <ogc:PropertyName>route</ogc:PropertyName>
                                <ogc:Literal>tram</ogc:Literal>
