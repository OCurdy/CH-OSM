<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>ch_proposed</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_proposed</sld:Name>
            <sld:FeatureTypeStyle>  
      <!-- symbolisation des points -->
        <sld:Rule> <!--règle pour visualisation à échelle worldwide, [MIN:zoom4 et +-->
        <sld:Title>Projet de construction ponctuelle
            <sld:Localized lang="de">Punktuelles Bauprojekt</sld:Localized>
            <sld:Localized lang="fr">Projet de construction ponctuelle</sld:Localized>
            <sld:Localized lang="it">Progetto di costruzione puntuale</sld:Localized>
            <sld:Localized lang="rm">Project da construcziun punctual</sld:Localized>
            <sld:Localized lang="en">Point Construction Project</sld:Localized>
        </sld:Title>
          <ogc:Filter>
           <ogc:Or> 
      ...
      <sld:FeatureTypeStyle>
       <!-- symbolisation des lignes, filtrage par géométrie pour ne pas prendre en compte les points (geom) des chemins qui sont différents des POI-->
          ...
          <sld:Title>Projet de construction linéaire
              <sld:Localized lang="de">Lineares Bauprojekt</sld:Localized>
              <sld:Localized lang="fr">Projet de construction linéaire</sld:Localized>
              <sld:Localized lang="it">Progetto di costruzione lineare</sld:Localized>
              <sld:Localized lang="rm">Project da construcziun lineara</sld:Localized>
              <sld:Localized lang="en">Linear Construction Project</sld:Localized>
          </sld:Title>
