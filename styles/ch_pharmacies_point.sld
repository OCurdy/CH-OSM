<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>ch_pharmacies_point</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_pharmacies_point</sld:Name>
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule> <!--règle pour visualisation à échelle locale, MAX:zoom12] et - -->
          ...
          <sld:Title>Pharmacie
              <sld:Localized lang="de">Apotheke</sld:Localized>
              <sld:Localized lang="fr">Pharmacie</sld:Localized>
              <sld:Localized lang="it">Farmacia</sld:Localized>
              <sld:Localized lang="rm">Apoteca</sld:Localized>
              <sld:Localized lang="en">Pharmacy</sld:Localized>
          </sld:Title>
          <ogc:Filter>
