<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>ch_buslines_line</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_buslines_line</sld:Name>
      <sld:Title/>
      <sld:FeatureTypeStyle>
        <sld:Name>ch_buslines_line</sld:Name>
        <sld:Rule>
          <sld:Name>Ligne de bus</sld:Name>
          <sld:Title>Ligne de bus
              <sld:Localized lang="de">Buslinie</sld:Localized>
              <sld:Localized lang="fr">Ligne de bus</sld:Localized>
              <sld:Localized lang="it">Linea di autobus</sld:Localized>
              <sld:Localized lang="en">Bus Line</sld:Localized>
              <sld:Localized lang="rm">Ligna d'autobus</sld:Localized>
          </sld:Title>
          <ogc:Filter>
        ...
        <sld:Rule>
          <!--sld:Name>Ligne de bus Label TextSymbolizer</sld:Name-->
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
                                <ogc:PropertyName>route</ogc:PropertyName>
                                <ogc:Literal>bus</ogc:Literal>
