<?xml version="1.0" encoding="UTF-8"?><!--File Generated by symbo.xsl from Excel VCR Symbology StyleSheet--><!--Geometry Type LINE--><sld:StyledLayerDescriptor version="1.0.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:sld="http://www.opengis.net/sld">
  <sld:NamedLayer>
    <sld:Name>ch_motorways_line</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_motorways_line</sld:Name>
      <sld:Title/>
      <sld:FeatureTypeStyle>
        <sld:Name>ch_motorways_line</sld:Name>
        <sld:Rule>
          <sld:Name>autoroute (motorway)</sld:Name>
          <sld:Title>Autoroute (motorway)
              <sld:Localized lang="de">Autobahn (motorway)</sld:Localized>
              <sld:Localized lang="fr">Autoroute (motorway)</sld:Localized>
              <sld:Localized lang="it">Autostrada (motorway)</sld:Localized>
              <sld:Localized lang="rm">Autostrada (motorway)</sld:Localized>
