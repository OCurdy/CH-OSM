  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <Rule>
          <Name>Entre 100 et 200 magasins</Name>
          <ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                ...
                <Fill>
                  <CssParameter name="fill">#e6b1e6</CssParameter>
                </Fill>
              </Mark>
              <Size>15</Size>
            </Graphic>
        ...
        <Rule>
          <Name>Entre 200 et 400 magasins</Name>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>count</ogc:PropertyName>
              <ogc:LowerBoundary>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                <WellKnownName>circle</WellKnownName>
                <Fill>
                  <CssParameter name="fill">#d98bd9</CssParameter>
                </Fill>
              </Mark>
              <Size>20</Size>
            </Graphic>
        ...
        <Rule>
          <Name>Entre 400 et 800 magasins</Name>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>count</ogc:PropertyName>
              <ogc:LowerBoundary>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                <WellKnownName>circle</WellKnownName>
                <Fill>
                  <CssParameter name="fill">#cc65cc</CssParameter>
                </Fill>
              </Mark>
              <Size>30</Size>
            </Graphic>
        ...
        <Rule>
          <Name>Plus de 800 magasins</Name>
          <ogc:Filter>
          ...
          <PointSymbolizer>
            <Graphic>
              <Mark>
                <WellKnownName>circle</WellKnownName>
                <Fill>
                  <CssParameter name="fill">#bf3fbf</CssParameter>
                </Fill>
              </Mark>
              <Size>35</Size>
            </Graphic>
