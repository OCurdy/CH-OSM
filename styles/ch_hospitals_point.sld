<?xml version="1.0" encoding="UTF-8"?><sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>ch_hospitals_point</sld:Name>
    <sld:UserStyle>
      <sld:Name>ch_hospitals_point</sld:Name>
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule> <!--règle pour visualisation à échelle locale, MAX:zoom12] et - -->
          ...
          <sld:Title>
              <sld:Localized lang="de">Krankenhaus</sld:Localized>
              <sld:Localized lang="fr">hôpital</sld:Localized>
              <sld:Localized lang="it">ospedale</sld:Localized>
              <sld:Localized lang="rm">spital</sld:Localized>
              <sld:Localized lang="en">hospital</sld:Localized>
          </sld:Title>
          <ogc:Filter>
        ...
        <sld:Rule> <!--règle pour visualisation à échelle national, [MIN:zoom6-MAX:zoom5]-->
          <sld:Name>hôpital</sld:Name>
          <sld:Title>Hôpital
              <sld:Localized lang="de">Spital</sld:Localized>
              <sld:Localized lang="fr">Hôpital</sld:Localized>
              <sld:Localized lang="it">Ospedale</sld:Localized>
              <sld:Localized lang="rm">Spital</sld:Localized>
              <sld:Localized lang="en">Hospital</sld:Localized>
